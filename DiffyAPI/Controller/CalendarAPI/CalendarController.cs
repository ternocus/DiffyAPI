...
namespace DiffyAPI.Controller.CalendarAPI
{
	...
	public class CalendarController : ControllerBase
	{
		...
		[HttpGet("DeletePoll")]
		public async Task<IActionResult> DeletePoll([FromQuery][Required] int idPoll)
		{
			try
			{
				return Ok(await _calendarManager.DeletePoll(idPoll));
			}
			catch (Exception ex)
			{
				_logger.LogError(ex, ex.Message);
